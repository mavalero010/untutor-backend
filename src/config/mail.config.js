                            ...
                            <td style="word-break:break-word;font-size:0px;padding:0px 0px 20px;" align="left">
                              <div
                                ...
                                <p><img src="https://cdn.discordapp.com/email_assets/127c95bbea39cd4bc1ad87d1500ae27d.png"
                                    alt="Party Wumpus" title="None" width="500" style="height: auto;"></p>
                                ...
                                <h2
                                  ...
                                  Hey ${name},</h2>
                                <p>Wowwee! Thanks for registering an account with Discord! You're the coolest person in all
                                  the land (and I've met a lot of really cool people).</p>
                          ...
                          <tr>
                            <td style="word-break:break-word;font-size:0px;padding:10px 25px;" align="center">
                              <table role="presentation" cellpadding="0" cellspacing="0" style="border-collapse:separate;"
                                ...
                                <tbody>
                                  <tr>
                                    <td style="border:none;border-radius:6px;color:white;cursor:auto;padding:15px 80px;"
                                      align="center" valign="middle" bgcolor="#7289DA"><a
                                        href='${process.env.HOST}/api/${process.env.VERSION_API}/user/confirm/${token}'
                        ...
                        <tr>
                          <td style="word-break:break-word;font-size:0px;padding:0px;" align="center">
                            <div
                              ...
                              Sent by Discord • <a href="https://blog.discordapp.com/"
                                style="color:#1EB0F4;text-decoration:none;" target="_blank">check our blog</a> • <a
                                href="https://twitter.com/discordapp" style="color:#1EB0F4;text-decoration:none;"
                              ...
                              <table role="presentation" cellpadding="0" cellspacing="0" style="border-collapse:separate;"
                                ...
                                <tbody>
                                  <tr>
                                    <td style="border:none;border-radius:6px;color:white;cursor:auto;padding:15px 80px;"
                                      align="center" valign="middle" bgcolor="#7289DA"><a
                                        href='${process.env.HOST}/api/${process.env.VERSION_API}/admin/confirm/${token}'
                                        style="text-decoration:none;line-height:100%;background:#7289DA;color:white;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:15px;font-weight:normal;text-transform:none;margin:0px;"
                                        target="_blank">
                                        Verify Email
                                      </a></td>
